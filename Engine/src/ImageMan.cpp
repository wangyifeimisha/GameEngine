...
namespace Azul
{
    ...
    Image *ImageMan::Add(Image::Name imageName, TextureObject::Name textName, Rect rect)

    {
        ...
        TextureObject *pText = TexNodeMan::Find(textName);
        assert(pText);

        // Initialize the date
        pNode->Set(imageName, pText, rect);
